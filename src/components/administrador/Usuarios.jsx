    ...
    const obtenerRolesUsuario = async (usuario) => {
        try {
            const response = await axios.get(
                `http://${direccionIP}/usuario_roluniversidad_universidad/findByUsuario?rut=${usuario.rut}`
            );
                                            ...
                                            <ul style={{ margin: '0px' }}>
                                                {Object.keys(usuario.rol_plataforma).map((index) => (
                                                    <li key={index}>
                                                        ...
                                                        {usuario.rol_plataforma[index]?.fila?.nombre}
                                                        <br />
                                                        <strong> Rol: </strong>{' '}
                                                        {usuario.rol_plataforma[index]?.fila?.nombreRolUniversidad}
                                                    </li>
                                                ))}
                                            </ul>
                                        </td>
